...
export interface GlobalHeaderProps extends Partial<PureSettings> {
  ...
  subRightContentRender?: WithFalse<(props: HeaderViewProps) => React.ReactNode>;
  leftContentRender?: WithFalse<(props: HeaderViewProps) => React.ReactNode>;
  className?: string;
  prefixCls?: string;
