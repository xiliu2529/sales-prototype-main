...
class RankSix extends Component<RankSixProps>{
 ...
 /*  // eslint-disable-next-line prefer-const
      ...
      series: [
        {
          name: name,
          animation: false,
          color: [ '#F0F0F0', '#F0F0F0', '#F0F0F0','#F0F0F0','#F0F0F0','#ff6d73','#F0F0F0'],
          type: 'pie',
          radius: [35, 50],
          center: [60, 60],
          labelLine: {
    ...
    render() {
    const {rankSix,value1,value2,value3,value4,value5,value6,value7} = this.props;
    return (
        <ReactEcharts option={this.getOption(rankSix,value1,value2,value3,value4,value5,value6,value7)} style={{ width: '100%', height: '34.2%' }}/>
    );
  }
}

export default RankSix;
