...
export interface RankFourProps {
  rankFour:RankOrder[];
  value1:[];
  value2:[];
  value3:[];
...
class RankFour extends Component<RankFourProps>{
 ...
 /*  // eslint-disable-next-line prefer-const
      ...
      series: [
        {
          name: name,
          animation: false,
          color: [ '#F0F0F0', '#F0F0F0', '#F0F0F0','#86EB9F','#F0F0F0','#F0F0F0','#F0F0F0'],
          type: 'pie',
          radius: [35, 50],
          center: [60, 60],
          labelLine: {
    ...
    render() {
    const {rankFour,value1,value2,value3,value4,value5,value6,value7} = this.props;
    return (
        <ReactEcharts option={this.getOption(rankFour,value1,value2,value3,value4,value5,value6,value7)} style={{ width: '100%', height: '33%' }}/>
    );
  }
}

export default RankFour;
