...
class RankAtoD extends Component<RankAtoProps>{

  getOption = (rankAtoD: any,value1:any,value2:any,value3:any,value4:any)=>{
    ...
    // eslint-disable-next-line prefer-const
    belowValue = undefined===rankAtoD?'':`{d|${formatNum(parseFloat(rankAtoD.amount).toFixed(0))}}`;

    // eslint-disable-next-line prefer-const
    topValueSting =  undefined===rankAtoD?'':`{b|${topValue}}{d|${parseFloat(rankAtoD.percent).toFixed(0)}% }`;
    ...
    // eslint-disable-next-line prefer-const
    name= undefined !== rankAtoD ? rankAtoD.caseIndstyCd : '';
    /*  // eslint-disable-next-line prefer-const
      ...
      series: [
        {
          name: name,
          animation: false,
          color: [ '#F0F0F0', '#F0F0F0', '#5CD1FF','#F0F0F0'],
          type: 'pie',
          radius: [35, 50],
          center: [60, 60],
          labelLine: {
  ...
  render() {
    const {rankAtoD,value1,value2,value3,value4} = this.props;
    return (
      <ReactEcharts option={this.getOption(rankAtoD,value1,value2,value3,value4)} style={{ width: '100%', height: '34.2%' }}/>
    );
  }
}

export default RankAtoD;
