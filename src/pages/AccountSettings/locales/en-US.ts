export default {
  ...
  'accountsettings.PersonalSettings': 'Personal settings',
  'accountsettings.PersonalInformation': 'Personal information',
  'accountsettings.Name': 'Name',
  'accountsettings.Company': 'Company',
  'accountsettings.Department': 'Department',
  'accountsettings.Title': 'Title',
  'accountsettings.Email': 'Email',
  'accountsettings.SystemSetting': 'System setting',
  'accountsettings.Year': 'Year',
  'accountsettings.ViewData': 'View data for your setting year.',
  'accountsettings.OldPassword': 'Old password',
  ...
  'accountsettings.ViewDataFor': 'View data for %?',
  'accountsettings.confirm': 'Yes',
  'accountsettings.cancel': 'No',

  // error
  'accountsettings.errorMsgInput': 'Please input Email.',
  'accountsettings.errorMsgContact': 'Email is incorrect.',
};
