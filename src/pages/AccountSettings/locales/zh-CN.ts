export default {
  ...
  'accountsettings.PersonalSettings': '个人设置',
  'accountsettings.PersonalInformation': '个人信息',
  'accountsettings.Name': '姓名',
  'accountsettings.Company': '公司',
  'accountsettings.Department': '部门',
  'accountsettings.Title': '职位',
  'accountsettings.Email': '电子邮件',
  'accountsettings.SystemSetting': '系统设定',
  'accountsettings.Year': '表示年份',
  'accountsettings.ViewData': '查看设定年份的数据。',
  'accountsettings.OldPassword': '旧密码',
  'accountsettings.NewPassword': '新密码',
  'accountsettings.ConfirmPassword': '确认密码',
  'accountsettings.ChangePassword': '更改密码',
  'accountsettings.ViewDataFor': '显示数据切换成%年?',
  'accountsettings.confirm': '确定',
  'accountsettings.cancel': '取消',

  // error
  'accountsettings.errorMsgInput': '请输入电子邮件。',
  'accountsettings.errorMsgContact': '邮件地址不正确。',
};
